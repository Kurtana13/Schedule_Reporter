        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinWorkDaysPerMonth = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSummaries_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeWorkDays", x => new { x.EmployeeId, x.WorkDayId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkDays_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkDays_WorkDays_WorkDayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSummaries_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkDays_StatusId",
                table: "EmployeeWorkDays",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkDays_WorkDayId",
                table: "EmployeeWorkDays",
                column: "WorkDayId");
        }
